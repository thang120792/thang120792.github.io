...
function exportToWord() {
    ...
    if (formType === 'mau_25_qd2604') {
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:16pt; font-family:'Times New Roman', serif;">
            <tr>
                <td width="50%" align="center" valign="top"></td>
                <td width="50%" align="center" valign="top">
                    <p class="MsoNormal" style="font-style:italic; font-size:11pt; text-align:center;">${dateStr}</p>
                    <p class="MsoNormal" style="font-weight:bold; font-size:11.5pt; text-align:center;">Người sử dụng đất/Người kê khai</p>
                    <p class="MsoNormal" style="font-size:10pt; font-style:italic; text-align:center;">(Ký, ghi rõ họ tên hoặc đóng dấu (nếu có))</p>
                    <div style="height:60pt;"></div>
                    <p class="MsoNormal" style="font-weight:bold; font-size:12pt; text-align:center;">${cleanName !== 'Mau_Don' ? cccdHoten : ''}</p>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:16pt; font-family:'Times New Roman', serif;">
            <tr>
                ...
                <td width="50%" align="center" valign="top">
                    <p class="MsoNormal" style="font-style:italic; font-size:11pt; text-align:center;">${dateStr}</p>
                    <p class="MsoNormal" style="font-weight:bold; font-size:11.5pt; text-align:center;">Người viết đơn</p>
                    <p class="MsoNormal" style="font-size:10pt; font-style:italic; text-align:center;">(Ký, ghi rõ họ tên và đóng dấu nếu có)</p>
                    <div style="height:60pt;"></div>
                    <p class="MsoNormal" style="font-weight:bold; font-size:12pt; text-align:center;">${cleanName !== 'Mau_Don' ? cccdHoten : ''}</p>
                </td>
            </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:16pt; font-family:'Times New Roman', serif;">
            <tr>
                ...
                <td width="50%" align="center" valign="top">
                    <p class="MsoNormal" style="font-style:italic; font-size:11pt; text-align:center;">${dateStr}</p>
                    <p class="MsoNormal" style="font-weight:bold; font-size:11.5pt; text-align:center;">Người viết đơn <sup>(4)</sup></p>
                    <p class="MsoNormal" style="font-size:10pt; font-style:italic; text-align:center;">(Ký và ghi rõ họ tên, đóng dấu nếu có)</p>
                    <div style="height:60pt;"></div>
                    <p class="MsoNormal" style="font-weight:bold; font-size:12pt; text-align:center;">${cleanName !== 'Mau_Don' ? cccdHoten : ''}</p>
                </td>
            </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:16pt; font-family:'Times New Roman', serif;">
            <tr>
                <td width="50%" align="center" valign="top">
                    <p class="MsoNormal" style="font-style:italic; font-size:10pt; text-align:center;">Ngày ……. tháng …… năm …...</p>
                    <p class="MsoNormal" style="font-weight:bold; font-size:11pt; text-align:center;">NGƯỜI KIỂM TRA</p>
                    <p class="MsoNormal" style="font-size:10pt; font-style:italic; text-align:center;">(Ký, ghi rõ họ tên, chức vụ)</p>
                </td>
                <td width="50%" align="center" valign="top">
                    <p class="MsoNormal" style="font-style:italic; font-size:10pt; text-align:center;">Ngày ……. tháng …… năm …...</p>
                    <p class="MsoNormal" style="font-weight:bold; font-size:11pt; text-align:center;">VĂN PHÒNG ĐĂNG KÝ ĐẤT ĐAI/CHI NHÁNH</p>
                    <p class="MsoNormal" style="font-size:10pt; font-style:italic; text-align:center;">(Ký, ghi rõ họ tên, chức vụ, đóng dấu)</p>
                </td>
            </tr>
        </table>
        `;
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (trimmed.startsWith('|') && trimmed.endsWith('|')) {
                ...
                bodyHtml += `<table border="1" cellspacing="0" cellpadding="4" style="border-collapse:collapse; width:100%; font-size:10pt; text-align:center; font-family:'Times New Roman', serif; border:1px solid #000; margin:8pt 0;">`;
